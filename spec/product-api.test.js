...
describe('GET /products/:product_id', () => {
  ...
  it('returns a product object with an empty features array when a product has no features', async () => {
    const expected = {
      "id": 10,
      "name": "Infinity Stone",
...
describe('GET /products/:product_id/styles', () => {
  it('returns a product styles object', async () => {
    const expected = {
      "product_id": 1,
      "results": [
          {
  ...
  it('returns an object with an id and an empty array for style results when a product has no styles', async () => {
    const expected = {
      "product_id": "11",
      "results": []
    };
    const res = await request(app).get('/products/11/styles');
    expect(res.status).toBe(200);
    expect(res._body).toEqual(expected);
  })
});
...
describe('GET /products/:product_id/related', () => {
  it('returns an array of related product ids', async () => {
    const expected = [2, 3, 8, 7];
    const res = await request(app).get('/products/1/related');
    expect(res.status).toBe(200);
    expect(res._body).toEqual(expected);
  });
  it('returns an empty array when there are no related products', async () => {
    const expected = [];
    const res = await request(app).get('/products/11/related');
    expect(res.status).toBe(200);
    expect(res._body).toEqual(expected);
  });
});

describe('GET /products/:product_id/overview', () => {
  it('returns a product overview data object', async () => {
    const expected = {
      "id": 1,
      "name": "Camo Onesie",
      "category": "Jackets",
    ...
    const res = await request(app).get('/products/1/overview');
    expect(res.status).toBe(200);
    expect(res._body).toEqual(expected);
  });
});

describe('GET /products/:product_id/related-cards', () => {
  it('returns an array of related product cards', async () => {
    const expected = [
      {
          "id": 2,
          "name": "Bright Future Sunglasses",
          ...
          "styles": [
              {
                  "style_id": 7,
                  "style_name": "Black Lenses & Black Frame",
                  "original_price": 69,
                  "sale_price": null,
                  "default?": false,
                  "photos": null
              ...
              {
                  "style_id": 8,
                  "style_name": "Black Lenses & Gold Frame",
                  "original_price": 69,
                  "sale_price": null,
                  "default?": false,
                  "photos": null
              ...
              {
                  "style_id": 9,
                  "style_name": "Gold Lenses & Black Frame",
                  "original_price": 69,
                  "sale_price": null,
                  "default?": false,
                  "photos": null
              ...
              {
                  "style_id": 10,
                  "style_name": "Gold Lenses & Gold Frame",
                  "original_price": 69,
                  "sale_price": null,
                  "default?": false,
                  "photos": null
    ...
    const res = await request(app).get('/products/1/related-cards');
    expect(res.status).toBe(200);
    expect(res._body).toEqual(expected);
  });
});

describe('GET /products/:product_id/card', () => {
  it('returns a product card object', async () => {
    const expected = {
      "id": 1,
      "name": "Camo Onesie",
      "category": "Jackets",
    ...
    const res = await request(app).get('/products/1/card');
    expect(res.status).toBe(200);
    expect(res._body).toEqual(expected);
  });
});